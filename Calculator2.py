...
button_minus = tk.Button(root, text="-", padx=42, pady=20, command=lambda: button_press("-"))
button_multiply = tk.Button(root, text="*", padx=41, pady=20, command=lambda: button_press("*"))
